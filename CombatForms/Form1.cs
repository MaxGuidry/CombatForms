    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            foreach(var e in Combat.Instance.Entities)
            {
                ...
                {
                    (e as Player).OnLevelUp += delegate { this.Enabled = false; System.Diagnostics.Debug.Print("LEVEL UP::" + e.Name); };
                }
            }
        ...
        public List<Control> CreateControls()
        {
            ...
            foreach(Entity e in Combat.Instance.Entities)
            {
                ...
                e.Info.Size = new System.Drawing.Size(100, 100);
